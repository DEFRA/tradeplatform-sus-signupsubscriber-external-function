...
public sealed class SignUpCreateMessageHeaderValidatorTests : ValidatorTestBase<MessageHeader>
{
    private readonly SignUpCreateMessageHeaderValidator _sut;

    public SignUpCreateMessageHeaderValidatorTests()
    {
        _sut = new SignUpCreateMessageHeaderValidator();
    }
    ...
    public static TheoryData<ModelSetter[], ErrorDetails[]> GetTestData()
    {
        ...
        return new()
        {
            ...
            { new[]{ Set(x => x.Label, null) }, new ErrorDetails[] { new("Label", "Label must be sus.remos.signup") } },
            { new[]{ Set(x => x.Label, "abc") }, new ErrorDetails[] { new("Label", "Label must be sus.remos.signup") } },
            ...
            { new[]{ Set(x => x.SchemaVersion, null) }, new ErrorDetails[] { new("SchemaVersion", "Schema Version must be 1") } },
            { new[]{ Set(x => x.SchemaVersion, "abc") }, new ErrorDetails[] { new("SchemaVersion", "Schema Version must be 1") } },
